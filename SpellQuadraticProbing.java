 ...
 * quadratic probing. It uses the class HashtableQuadratic.
 */
class SpellQuadraticProbing {
    public static void main(String[] args) {
        ...
        table = new HashtabelQuadratic(hash_size, function); // table = new Hashtable<String, String>(hash_size);
